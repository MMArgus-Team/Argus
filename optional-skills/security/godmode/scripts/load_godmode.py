...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("ARGUS_HOME", os.path.expanduser("~/.argus")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("ARGUS_HOME", Path.home() / ".argus")) / "skills" / "red-teaming" / "godmode" / "scripts"
