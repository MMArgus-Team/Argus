...
// Click-to-edit was intentionally removed: user bubbles are now read-only
// (no ActionBarPrimitive.Edit trigger, no overlaid "Edit message" button).
// The UserEditComposer component still exists — it is entered via checkpoint
// branching, not by clicking the message. These tests asserted the old
// click-bubble-to-edit flow and are retired with the feature.
describe.skip('click-to-edit user message (feature removed)', () => {
