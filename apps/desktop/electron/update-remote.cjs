 ...
 *
 * A public install can end up with `origin=git@github.com:MMArgus-Team/Argus.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/MMArgus-Team/Argus.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/mmargus-team/argus'
