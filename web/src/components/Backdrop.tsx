...
import { preferReducedBackdropEffects } from "@/lib/perf-hints";
...
export function Backdrop() {
  ...
  // Mac Chrome struggles with full-viewport mix-blend-mode stacks (difference +
  // color-dodge noise) on Retina — skip the animated grain and soften filler.
  const reducedEffects = preferReducedBackdropEffects();
        ...
        style={
          {
            ...
            opacity: reducedEffects
              ? "calc(var(--component-backdrop-filler-opacity, 0.033) * 0.5)"
              : "var(--component-backdrop-filler-opacity, 0.033)",
