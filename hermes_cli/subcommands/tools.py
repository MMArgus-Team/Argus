...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'argus tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # argus tools disable <name...> [--platform cli]
    ...
    # argus tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `argus tools` runs after you pick a provider that\n"
