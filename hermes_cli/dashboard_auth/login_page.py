...
<title>Sign in — Argus Agent</title>
<style>
...
<body>
<main>
  <div class="brand">MM<span class="dot"></span>Argus</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Argus Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Argus Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
