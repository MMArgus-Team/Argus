...
def profile_env(tmp_path, monkeypatch):
    """Set up a global root + an active profile under Path.home()/.argus/profiles/coder.

    * Path.home() -> tmp_path
    * Global root -> tmp_path/.argus            (has its own auth.json fixture)
    * Profile     -> tmp_path/.argus/profiles/coder   (active, HERMES_HOME points here)
...
def test_classic_mode_does_not_double_read_same_file(tmp_path, monkeypatch):
    ...
    # sees tmp_path/home/.argus as the "real home" — which is NOT equal
    ...
    # ~/.argus/profiles/ — get_default_hermes_root() returns HERMES_HOME
