...
""",
    ...
    monkeypatch.setenv("ARGUS_NEMO_RELAY_PLUGINS_TOML", str(plugins_toml))
...
def test_nemo_relay_plugin_is_discoverable_as_bundled_plugin(tmp_path, monkeypatch):
    monkeypatch.setenv("ARGUS_HOME", str(tmp_path / "hermes_test"))
...
def test_nemo_relay_plugin_emits_llm_tool_and_exports_atif(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATOF_ENABLED", "1")
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY", str(tmp_path / "atof"))
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_ENABLED", "1")
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY", str(tmp_path / "atif"))
...
def test_nemo_relay_plugin_can_write_embedded_child_atif_file_in_all_mode(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_ENABLED", "1")
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY", str(tmp_path / "atif"))
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE", "all")
...
""",
    ...
    monkeypatch.setenv("ARGUS_NEMO_RELAY_PLUGINS_TOML", str(plugins_toml))
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_ENABLED", "1")
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY", str(tmp_path / "direct-atif"))
...
""",
    ...
    monkeypatch.setenv("ARGUS_NEMO_RELAY_PLUGINS_TOML", str(plugins_toml))
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATOF_ENABLED", "1")
    monkeypatch.setenv("ARGUS_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY", str(tmp_path / "direct-atof"))
