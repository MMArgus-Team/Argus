...
Run from the PR worktree:
    ...
    cd ~/.argus/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.argus/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.argus/hermes-agent
