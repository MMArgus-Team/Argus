...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("ARGUS_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("ARGUS_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("ARGUS_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
