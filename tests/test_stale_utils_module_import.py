...
Real incident (gateway session 1518671026962174144)::
    ...
    cannot import name 'env_float' from 'utils' (~/.argus/hermes-agent/utils.py)
...
2. ``argus update`` ran ``git pull``, updating ``utils.py`` (now defining
...
``hermes_cli/main.py`` (the ``argus update`` flow, ~line 9326) already
