...
class TestHermesTimeNow:
    ...
    def test_valid_timezone_applies(self):
        ...
        os.environ["ARGUS_TIMEZONE"] = "Asia/Kolkata"
    ...
    def test_us_eastern(self):
        ...
        os.environ["ARGUS_TIMEZONE"] = "America/New_York"
        result = hermes_time.now()
        assert result.tzinfo is not None
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        os.environ["ARGUS_TIMEZONE"] = "Mars/Olympus_Mons"
...
class TestGetTimezone:
    ...
    def test_returns_zoneinfo_for_valid(self):
        os.environ["ARGUS_TIMEZONE"] = "Europe/London"
    ...
    def test_returns_none_for_invalid(self):
        os.environ["ARGUS_TIMEZONE"] = "Not/A/Timezone"
        tz = hermes_time.get_timezone()
        assert tz is None
...
class TestCodeExecutionTZ:
    ...
    def test_tz_injected_when_configured(self):
        """When ARGUS_TIMEZONE is set, child process sees TZ env var.
        ...
        #   2) ARGUS_TIMEZONE itself does NOT leak into the child env
        probe = (
            'import os; '
            'print("TZ=" + os.environ.get("TZ", "NOT_SET")); '
            'print("ARGUS_TIMEZONE=" + os.environ.get("ARGUS_TIMEZONE", "NOT_SET"))'
        )
        ...
        assert "ARGUS_TIMEZONE=NOT_SET" in result["output"], (
            "ARGUS_TIMEZONE should not leak into child env (only TZ)"
        )

    def test_tz_not_injected_when_empty(self):
        """When ARGUS_TIMEZONE is not set, child process has no TZ."""
        import json as _json
        os.environ.pop("ARGUS_TIMEZONE", None)
...
class TestCronTimezone:
    ...
    def test_get_due_jobs_naive_cross_timezone(self, tmp_path, monkeypatch):
        ...
        os.environ["ARGUS_TIMEZONE"] = "Pacific/Midway"  # UTC-11
        _reset_hermes_time_cache()
    ...
    def test_create_job_stores_tz_aware_timestamps(self, tmp_path, monkeypatch):
        ...
        os.environ["ARGUS_TIMEZONE"] = "US/Eastern"
        _reset_hermes_time_cache()
