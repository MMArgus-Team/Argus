...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.(?:argus|hermes)/\.env|\~/\.(?:argus|hermes)/\.env', "hermes_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.(?:argus|hermes)/(config\.yaml|SOUL\.md)', "hermes_config_mod", "strict"),
