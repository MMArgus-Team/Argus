...
DANGEROUS_PATTERNS = [
    ...
    # In-place edit of an Argus-managed security file (~/.argus/config.yaml or
    ...
    (rf'\bsed\s+-[^\s]*i.*(?:{_HERMES_CONFIG_PATH}|{_ARGUS_ENV_PATH})', "in-place edit of Argus config/env"),
    (rf'\bsed\s+--in-place\b.*(?:{_HERMES_CONFIG_PATH}|{_ARGUS_ENV_PATH})', "in-place edit of Argus config/env (long flag)"),
    ...
    (rf'\b(?:perl|ruby)\b.*(?:^|\s)-[^\s]*i\b.*(?:{_HERMES_CONFIG_PATH}|{_ARGUS_ENV_PATH})', "in-place edit of Argus config/env (perl/ruby)"),
