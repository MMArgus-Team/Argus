...
class Config:
    ...
    #   recall 走 Luna @ doc.devops/v1/chat/completions (视觉多图+文, tools 不
    #   需要, 命中率优先)。
    recall_provider: str = ""
    recall_base_url: str = ""
    recall_api_key: str = ""
    ...
    # ---- ★ AnySearch (text_search 的外部检索后端, 取代内网 sly RAG) ----
    ...
    # 兼容各类云 ASR:
    #   * 内部服务 (默认): multipart file → {"text": ...}, 无鉴权。
    ...
    asr_url: str = "http://10.217.71.99:8001/asr"
    ...
    # ---- TTS ----
    tts_url: str = "http://10.217.71.99:8002"
