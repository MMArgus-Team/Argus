...
MM_LIVE_GUIDANCE = (
    ...
    "or scene; asking what is visible now or what appeared earlier; displaying, retrieving, or inspecting "
    "current or historical frames; questions about papers, slides, tables, or figures seen in the stream; "
    "and requests for outside facts about a visually referenced entity. "
    ...
    "★ Frame retrieval routing: any request to display, replay, retrieve, inspect, or describe a current or "
    "historical stream frame goes through query_multimodal. Use direct mode for a self-contained visual request; "
    "use evidence mode only when the Main Agent must continue with other tools. Do not claim you can see frames "
    "from text context alone, and do not invent local image paths.\n"
    ...
    "set_live_watcher, or query_multimodal; those tools validate their own prerequisites. "
