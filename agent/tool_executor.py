...
from agent.turn_context import should_defer_turn_persistence
...
def _flush_session_db_after_tool_progress(
    ...
    *,
    ...
    """
    if (getattr(agent, "_suppress_incremental_tool_persistence", False)
            or should_defer_turn_persistence(agent)):
        return
    try:
