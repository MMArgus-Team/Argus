...
Built for [Argus Agent](https://github.com/MMArgus-Team/Argus). Usable in any coding agent. Canonical source lives here; synced to [`MMArgus-Team/Argus/skills/creative/ascii-video`](https://github.com/MMArgus-Team/Argus/tree/main/skills/creative/ascii-video) via PR.
